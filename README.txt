...
- "Application_EmptyProject" contains several Visual Studio solutions, for several platforms, 
  using together the same source file MainClass.cpp, and with working directories set to "WorkDir" 
  (except ..._Store app, which working directory is default one).
...
- "Doxyfile" is the Doxygen file, which requires Doxygen (http://www.stack.nl/~dimitri/doxygen/), 
