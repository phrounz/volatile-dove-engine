...
### setup.ini
 * Contains the global configuration file of the project. You shall run [generate_project.pl](../README.md#engine-source-code-and-dependancies) again to take into consideration any modification in this file.
